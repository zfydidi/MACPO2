...
| 同上（外部列） | GFPDO† / DPSO† | **GFPDO（1-run pilot）**：`MACPO_sourcecode/output_baselines_gfpdo_1run/`<br>**DPSO（25-run）**：`MACPO_sourcecode/output_baselines_dpso_25runs/` | `utils/external_baselines.py` | 缺日志时用文献 fallback |
