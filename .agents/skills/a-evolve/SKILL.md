...
**Benchmark results** (Codex Opus 4.6):
- MCP-Atlas: 79.4% (#1)
...
pip install a-evolve[anthropic]         # With Codex support
...
config = ae.EvolveConfig(
    ...
    evolver_model="us.anthropic.Codex-opus-4-6-v1",
)
...
|-------|--------|-------|-------------|
| `swe` | SWE-bench | Codex Opus 4.6 | Verify-fix loop, skill proposals |
| `terminal` | Terminal-Bench | Codex Sonnet 4 | Concurrent timeout, env discovery |
| `mcp` | MCP-Atlas | Codex Opus 4.6 | MCP server integration |
